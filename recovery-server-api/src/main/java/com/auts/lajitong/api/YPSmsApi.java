...
public class YPSmsApi {
	...
	public static String CAPTCHA_TEXT = "【智能回收箱】您的验证码是%s，有效期10分钟。";
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        //修改为您要发送的手机号
        String mobile = URLEncoder.encode("18615539629",ENCODING);
...
//        System.out.println(YPSmsApi.sendSms(YPSmsApi.API_KEY, String.format("【理财师】您的验证码是%s。如非本人操作，请忽略本短信", captchaCode), "15250065067"));
        System.out.println(YPSmsApi.sendSms(YPSmsApi.API_KEY, String.format(YPSmsApi.CAPTCHA_TEXT, captchaCode), "18615539629"));
